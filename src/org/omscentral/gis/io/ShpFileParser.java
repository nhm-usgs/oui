...
public class ShpFileParser {
     ...
     * constructor tries loading streams.shp. The constructor opens the file and
     * reads the header of the .shp file.
            ...
            public Object nextElement() {
                try {
                    ...
                    if (stype == POINT_SHAPE) {
                        return new VectorModel.PointFeature(shpStream.readLittleEndDouble(),
                    ...
                    switch (stype) {
                        case MULTIPOINT_SHAPE:
                            ...
                            return new VectorModel.MultiPointFeature(box, count, shpStream.readLittleEndDouble(count * 2));
                        ...
                        default:
                            throw new IllegalArgumentException("Unknow feature type: " + stype);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
