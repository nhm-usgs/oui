 ...
 * @author  markstro
 */
public class AnimationToolGui extends JPanel {
    ...
    public AnimationToolGui(SpaceTimeSeriesData tsd, GISPanel gisPanel,
            VectorTheme theme, String idAttributeName, String dispVarName, int numBins) {
        this.tsd = tsd;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(dateSlider, javax.swing.GroupLayout.DEFAULT_SIZE, 336, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(dateTextField)
                    .addComponent(showKeyBox, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void showKeyBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showKeyBoxActionPerformed
        if (showKeyBox.isSelected()) {
            kf = new KeyFrame(numBins, min, max, this);
            WindowFactory.displayInFrame(kf, "");
        } else {
            if (kf != null) {
    ...
    private void setMapData(double[] vals) {
        ...
        if (vcm == null) {
            vcm = OuiGui.getOuiGisPanel().getColorModel(theme);
            ...
            for (int i = 0; i < mod.getRecordCount(); i++) {
                hruMapping[i] = Integer.parseInt((mod.getAttribute(i, idAttributeIndex)).toString()) - 1;
//                System.out.println ("ANimationToolGui: hru mapping " + i + " " + hruMapping[i]);
            }
        }

        for (int i = 0; i < (theme).getFeatureCount(); i++) {
            vcm.setFillPaint(colorRange.getColorForValue(vals[hruMapping[i]]), hruMapping[i]);
        }
    ...
    void keyChanged(ColorRange cr) {
        this.colorRange = cr;
        setMapData(currentVals);
    }

    void setShowKeyBoxSelection(boolean b) {
