 ...
 * @version 2.0
 */
public class MMSSingleESPTreeNode extends OuiDataTreeNode {
     ...
     */
    public MMSSingleESPTreeNode(Node xml_node) {
        super(xml_node);
        ...
        espSeriesColumn = Integer.parseInt(pxml.getElementContent(xml_node, "@espSeriesCol", "set your esp series column!"));
    }
    ...
    public void queryData (Feature feature) {
        ...
        EspTool test = new EspTool(espInitFile, espSeriesFile, espInitVariable, title, espSeriesColumn);
