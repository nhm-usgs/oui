 ...
 * @author  markstro
 */
public class MmsOuiMultiBasinRunTreeNode extends MmsModelTreeNode implements MmsSingleModelRunner {
...
//    private String[] xrouteVariableIndex;
    ...
    public MmsOuiMultiBasinRunTreeNode(Node xml_node) {
        super(xml_node);
 ...
 */
        ...
        if (mmiNode == null) {
            System.out.println ("MmsOuiMultiBasinRunTreeNode.run: No mmi node found for " + mmi);
            return;
        }
 ...
 */
        for (int i = 0; i < subBasins.length; i++) {
            String datafile = " -set data_file " + mmsWorkspace + "/input/data/" + dataFile;            
            String statvarfilename = subBasins[i] + ".statvar";
            ...
            String control = " -C" + subBasins[i] + controlFileExt;
