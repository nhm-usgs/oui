 ...
 * @author  markstro
 */
public class MmsOuiMultiDataFileEspRunTreeNode extends MmsModelTreeNode implements MmsEspModelRunner {
...
//    private String data_file;
     ...
     * @param xml_node */
    public MmsOuiMultiDataFileEspRunTreeNode(Node xml_node) {
        super(xml_node);
 ...
 */
        ...
        if (showRunnerGui) {
            JOptionPane.showMessageDialog(GuiUtilities.windowFor(OuiGui.getTreeScrollPane()), "MmsOuiMultiDataFileEspRunTreeNode: run complete", "Run Status", JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
