...
//  DANGER -- this is a copy of org.omscentral.gis.io.DbfFileParser
//     I tried to extend DbfFileParser to return an OuiAttributeModel, but
//     couldn't bacause of the static methods.
 ...
 * @see
 * @version   $Revision: 1.1.1.1 $ / $Date: 2001/11/07 23:21:57 $
 */
...
public class OuiDbfFileParser {
   ...
   */
  public OuiDbfFileParser(String shapeFileBase) {
    file = shapeFileBase;
  }

  public static OuiAttributeModel createModel(String file) throws Exception {
    return createModel(new FileInputStream(file));
  }

  public static OuiAttributeModel createModel(InputStream file)throws Exception  {
    return readDbfData(new ByteOrderInputStream(file));
  }

  public OuiAttributeModel createModel() throws Exception {
...
//  private static AttributeModel readDbfData(ByteOrderInputStream dbfStream) throws Exception {
  public static OuiAttributeModel readDbfData(ByteOrderInputStream dbfStream) throws Exception {
    byte dbfVersion;
    byte dbfLastUpdate[];
    ...
    OuiAttributeModel model = new OuiAttributeModel(dbfColumns);
    model.dbfVersion = dbfVersion;
    model.dbfLastUpdate = dbfLastUpdate;
